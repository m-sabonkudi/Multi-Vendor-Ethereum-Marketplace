...
const WishlistPage = () => {
  ...
  useEffect(() => {
    async function fetchAllProducts() {
      ...
      try {
        ...
        const wishlistProducts = data.filter(p => wishlists.includes(p.id))
        setProducts(wishlistProducts)
        setFiltered(wishlistProducts)
      } catch (e) {
  ...
  useEffect(() => {
    ...
    navigate(`/wishlist?${params.toString()}`, { replace: true })
  ...
  return (
    ...
    {/* <h2 className='text-center mt-3 text-4xl font-bold mb-4 italic'>Your Wishlist</h2>       */}
  ...
  <div className="text-center py-10 text-muted-foreground">
    <Spinner />
    <h3 className="text-xl mt-4 font-semibold">Fetching wishlist cars...</h3>
    <p className="text-sm mt-2">Please hold on while we fetch your wishlist.</p>
  </div>
) : filtered.length > 0 ? (
  <>
    <p className="mb-6 text-muted-foreground text-sm">
      {filtered.length} Wishlisted Cars
    </p>
  ...
  <div className="text-center py-20 text-muted-foreground">
    ...
    <h3 className="text-xl font-semibold">No Wishlisted Cars</h3>
    <p className="text-sm mt-2">Try adding cars to your wishlist.</p>
  </div>
) : (
  <div className="text-center py-20 text-muted-foreground">
    <CarFront className="mx-auto w-12 h-12 mb-4" />
